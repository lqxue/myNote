...
不需要做任何配置，启动器已经帮我们把Thymeleaf的视图器配置完成：
 ...
 ![1526435647041](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526435647041.png)

而且，还配置了模板文件（html）的位置，与jsp类似的前缀+ 视图名 + 后缀风格：

 ![1526435706301](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526435706301.png)
...
效果：
 ...
 ![1526438010948](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526438010948.png)
...
现在，我们不经过SpringMVC，而是直接用浏览器打开页面看看：
 ...
 ![1526438337869](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526438337869.png)
...
```
 ...
 ![1526440538848](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526440538848.png)
...
- 字符串字面值
  ...
  `th:text`中的thymeleaf并不会被认为是变量，而是一个字符串
   ...
   ![1526958538157](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526958538157.png)
...
- 数字字面值
  ...
  ```
   ...
   ![1526958856078](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526958856078.png)
...
与上面是完全等效的，这样就省去了字符串字面值的书写。
 ...
 ![1526959781368](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526959781368.png)
...
- 算术运算
  ...
  ```
   ...
   ![1526959990356](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526959990356.png)
...
- 条件运算
  ...
  其中的每一个部分都可以是Thymeleaf中的任意表达式。
   ...
   ![1526960230778](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526960230778.png)
  ...
  注意：`?:`之间没有空格。
   ...
   ![1526960384564](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526960384564.png)
...
其它情况包括null都被认定为false
 ...
 ![1526960499522](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526960499522.png)
...
另外`th:case="*"`表示默认，放最后。
 ...
 ![1526960621714](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526960621714.png)

页面：

 ![1526961251878](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526961251878.png)
...
![1526961583904](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526961583904.png)
...
控制台：
 ...
 ![1526961525185](https://cdn.static.note.zzrfdsn.cn/images/project/leyoumall/thymeleaf/1526961525185.png)
